      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white animate-fade-in">
          ...
          <p className="text-xl max-w-3xl mx-auto mb-8 leading-relaxed">
            Донское казачество — уникальное явление в истории России, сочетающее воинскую доблесть, 
            самобытную культуру и богатые традиции. Познакомьтесь с историей народа, чьи корни уходят 
            в глубь веков, а голос звучит в бессмертных произведениях литературы.
          </p>
          <Button 
            size="lg" 
